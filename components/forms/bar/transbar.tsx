  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="md:text-3xl text-lg font-bold text-gray-800">تحلیل تراکنش‌های مالی</h1>
          <p className="text-gray-600 hidden md:block mt-1">نمای کلی از بدهکار و بستانکار سیستم</p>
        </div>
        <button
          onClick={fetchTransactions}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-purple-100 text-sm">تراکنش‌های امروز</p>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h3 className="text-xl font-bold text-gray-800 mb-6">خلاصه تراکنش‌ها بر اساس مشتری</h3>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h3 className="text-xl font-bold text-gray-800 mb-6">خلاصه تراکنش‌ها بر اساس کاربر</h3>
        ...
        {transactions.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            .map(([userName, data]) => (
              <div key={userName} className="bg-gray-50 rounded-lg p-4 border-l-4 border-purple-500">
                <div className="flex items-center justify-between mb-2">
                  <h4 className="font-semibold text-gray-800 truncate">{data.name}</h4>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h3 className="text-xl font-bold text-gray-800 mb-6">خلاصه ماهانه تراکنش‌ها</h3>
      ...
      <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-lg p-6 text-white">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="text-center">
            ...
            <p className="text-gray-300 text-sm">کل تراکنش‌ها</p>
          </div>
